...
class MyHouse extends CGFobject {
    constructor(scene) {
        ...
        this.columnTexture.setAmbient(0.3, 0.3, 0.3, 1);
        ...
        this.pipeMaterial.setAmbient(0.3, 0.3, 0.3, 1);
        ...
        this.doorTexture.setAmbient(0.3, 0.3, 0.3, 1);
        ...
        this.panelTexture.setAmbient(0.3, 0.3, 0.3, 1);
        ...
        this.wallTexture.setAmbient(0, 0, 0, 1);
        ...
        this.pathTexture.setAmbient(0.3, 0.3, 0.3, 1);
    ...
    display() {
        ...
        this.scene.translate(-4.05, 8.01, 0);
        ...
        this.scene.translate(1.51, 0.65, 0);
        ...
        this.scene.translate(4.5, 0.02, 0);
        this.scene.rotate(Math.PI / 2, 0, 1, 0);
