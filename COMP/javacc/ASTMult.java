  ...
  public void analyzeSemantics(ArrayList<SymbolTable> symbolTables, ArrayList<String> errors){
    ...
    if (!st.hasVariable(first_operand_name)) {
      ...
      if (first_operand_type.equals("")) {
        errors.add("ERROR: MULT includes a function call that does not exist: " + first_operand_name + ".");
        return;
      }       
    }
    ...
    if (second_operand.toString().equals("Identifier")) {
      ...
      if (!st.hasVariable(second_operand_name)) {
        ...
        if(missingVariable){
          errors.add("ERROR: MULT includes a variable that does not exist" +  second_operand_name + ".");
          return;
        }
      }
    }
      ...
      if (second_operand_type.equals("")) {
        errors.add("ERROR: MULT includes a function call that does not exist: " + second_operand_name + ".");
        return;
      }       
    }
    ...
    if(first_operand_type.equals("Array") || second_operand_type.equals("Array")){
      errors.add("ERROR: MULT cannot use arrays on arithmetic operations.");
      return;
    }
    ...
    if (first_operand_type.equals("") || second_operand_type.equals("")) {
      errors.add("ERROR: Incompatible MULT using a " + first_operand.toString() + " and a " + second_operand.toString() + ".");
      return;
    }
    ...
    if(verificationWithExpressions1st == false && verificationWithExpressions2st == false){
      if (!first_operand_type.equals(second_operand_type)){
        errors.add("ERROR: Incompatible MULT using " + first_operand_type + " and " + second_operand_type + ".");
        return;
      }
    }
...
/* JavaCC - OriginalChecksum=5a225f2d835b13ec2bcafb7500b3f30f (do not edit this line) */
