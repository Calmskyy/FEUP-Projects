  ...
  public void analyzeSemantics(ArrayList<SymbolTable> symbolTables, ArrayList<String> errors){
    ...
    SymbolTable st = null;
      ...
      if (!st.hasVariable(first_operand_name)) {
          ...
          if(missingVariable){
            errors.add("ERROR: SUB includes a variable that does not exist: " + first_operand_name + ".");
            return;
          }
        }
      }
      ...
      if (first_operand_type.equals("")) {
        errors.add("ERROR: SUB includes a function call that does not exist: " + first_operand_name + ".");
        return;
      }       
    }
    ...
    first_operand.toString() == "Div" || first_operand.toString() == "Dot" || first_operand.toString() == "ArrayAccess") {
      ...
      if (second_operand.toString().equals("Identifier")) {
        ...
        if (!st.hasVariable(second_operand_name)) {
          ...
          if(missingVariable){
            errors.add("ERROR: SUB includes a variable that does not exist" +  second_operand_name + ".");
            return;
          }
        }
      }
      ...
      if (second_operand_type.equals("")) {
        errors.add("ERROR: SUB includes a function call that does not exist: " + second_operand_name + ".");
        return;
      }       
    }
    ...
    second_operand.toString() == "Div" || second_operand.toString() == "Dot" || second_operand.toString() == "ArrayAccess") {
      ...
      if(first_operand_type.equals("Array") || second_operand_type.equals("Array")){
        errors.add("ERROR: SUB cannot use arrays on arithmetic operations.");
        return;
      }
      ...
      if (first_operand_type.equals("") || second_operand_type.equals("")) {
        errors.add("ERROR: Incompatible SUB using a " + first_operand.toString() + " and a " + second_operand.toString() + ".");
        return;
      }  
      ...
      if(verificationWithExpressions1st == false && verificationWithExpressions2st == false){
        if (!first_operand_type.equals(second_operand_type)){
          errors.add("ERROR: Incompatible SUB using " + first_operand_type + " and " + second_operand_type + ".");
          return;
        }
      }
...
/* JavaCC - OriginalChecksum=c19d1554b0648825e9927b483ce8b776 (do not edit this line) */
