...
class ASTDiv extends SimpleNode {
  ...
  public void analyzeSemantics(ArrayList<SymbolTable> symbolTables, ArrayList<String> errors){
    ...
    if (!st.hasVariable(first_operand_name)) {
        ...
        if(missingVariable){
          errors.add("ERROR: DIV includes a variable that does not exist: " + first_operand_name + ".");
          return;
        }
      }
    }
      ...
      if (first_operand_type.equals("")) {
        errors.add("ERROR: DIV includes a function call that does not exist: " + first_operand_name + ".");
        return;
      }       
    }
    ...
    if (second_operand.toString().equals("Identifier")) {
      ...
      if (!st.hasVariable(second_operand_name)) {
        ...
        if(missingVariable){
          errors.add("ERROR: DIV includes a variable that does not exist" +  second_operand_name + ".");
          return;
        }
      }
    }
      ...
      if (second_operand_type.equals("")) {
        errors.add("ERROR: DIV includes a function call that does not exist: " + second_operand_name + ".");
        return;
      }       
    }
    ...
    if(first_operand_type.equals("Array") || second_operand_type.equals("Array")){
      errors.add("ERROR: DIV cannot use arrays on arithmetic operations.");
      return;
    }
    ...
    if (first_operand_type.equals("") || second_operand_type.equals("")) {
      errors.add("ERROR: Incompatible DIV using a " + first_operand.toString() + " and a " + second_operand.toString() + ".");
      return;
    }
    ...
    if(verificationWithExpressions1st == false && verificationWithExpressions2st == false){
      if (!first_operand_type.equals(second_operand_type)){
        errors.add("ERROR: Incompatible DIV using " + first_operand_type + " and " + second_operand_type + ".");
        return;
      }
    }
  ...
  public String getCode(ArrayList<SymbolTable> symbolTables, SimpleNode stackMethod){
    ...
    if(this.jjtGetNumChildren() == 2){
      ...
      else if(first_child.toString().equals("Identifier")){
      ...
      else if(second_child.toString().equals("Identifier")){
...
/* JavaCC - OriginalChecksum=55ae6cbfa1454602bbcd15b411c16fa7 (do not edit this line) */
