...
BEGIN
    ...
    LOOP
        INSERT INTO notification (user_id, description, "date") VALUES (temp_user, 'A new bid has been made on an item you bid on: ' ||  NEW.item_id, now());
        INSERT INTO notification_item (notification_id, item_id) VALUES (currval('notification_id_seq'),  NEW.item_id);
    END LOOP;
RETURN NEW;
END
...
INSERT INTO "user" VALUES ( 0, 'placeholder', 'placeholder', 0, 'placeholder', 'placeholder', 'placeholder', 'false', 'false');
INSERT INTO "user" VALUES ( 1, 'Tiago Verdade', 'tiago@hotmail.com', 1, '91239123', 'ola a todos', 'adsadadda', 'false', 'false');
INSERT INTO "user" VALUES ( 2, 'Art Studio', 'artstudio@hotmail.com', 5, '2314124', 'Comprem as nossas cenas', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'false', 'false');
INSERT INTO "user" VALUES ( 3, 'Diogo Sousa', 'diogo@hotmail.com', 0, '912381351', '', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'false', 'false');
INSERT INTO "user" VALUES ( 4, 'User', 'user@hotmail.com', 0, '91239123', '', 'qwertyuiop', 'false', 'false');
INSERT INTO "user" VALUES ( 5, 'Museu Coimbra', 'coimbra_museum@hotmail.com', 0, '239123592', 'Bem vindos a nossa colecao', 'birthday123', 'false', 'false');
INSERT INTO "user" VALUES ( 6, 'testing website', 'test123@hotmail.com', 0, '', '', 'washingmachine', 'false', 'false');

INSERT INTO "user" VALUES (7,'Rafael','rafael@example.com',0.0,'914249435','','$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W','false', 'false');
-- mods
INSERT INTO "user" VALUES (8, 'Admin', 'admin@artbay.pt', NULL, NULL, NULL, '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'false', 'true');
INSERT INTO "user" VALUES (9, 'Supervisor', 'supervisor@artbay.pt', NULL, NULL, NULL, '19051970abc', 'false', 'true');
INSERT INTO "user" VALUES (10, 'CEO', 'ceo@artbay.pt', NULL, NULL, NULL, 'cupcake123', 'false', 'true');

SELECT setval('user_id_seq', max(id)) FROM "user";

INSERT INTO interest VALUES ( 1, 'Painting');
INSERT INTO interest VALUES ( 1, 'Sculpture');
INSERT INTO interest VALUES ( 2, 'Photography');
INSERT INTO interest VALUES ( 2, 'Painting');
INSERT INTO interest VALUES ( 3, 'Ceramics');
INSERT INTO interest VALUES ( 5, 'Painting');
INSERT INTO interest VALUES ( 5, 'Sculpture');
INSERT INTO interest VALUES ( 5, 'Photography');
INSERT INTO interest VALUES ( 5, 'Serigraphy');
INSERT INTO interest VALUES ( 5, 'Ceramics');
...
INSERT INTO auction_item VALUES ( 2, 2000, 10, TIMESTAMP '2020-06-01 22:30:23');
INSERT INTO auction_item VALUES ( 3, 150000, 1000, timestamp '2020-06-02 14:30:00');
INSERT INTO purchase_item VALUES ( 1, 300000);

INSERT INTO item_history VALUES (2, 7, 'VENEZA EM AGUARELA', 'false');
...
INSERT INTO review VALUES (1, 2, 1, 'Not so good but ok.', 3);
INSERT INTO review VALUES (7, 2, 1, 'Item arrived in perfect conditions.', 5);
...
INSERT into notification VALUES (DEFAULT, 1, 'You have been outbid on an item: Mona Lisa', timestamp '2020-04-29 23:30:00');
INSERT into notification VALUES (DEFAULT, 3, 'You have been outbid on an item: Mona Lisa', timestamp '2020-04-29 23:35:00');
INSERT into notification VALUES (DEFAULT, 6, 'Your comment on the following item has been deleted: Venus de Milo', timestamp '2020-05-04 09:05:00');
INSERT into notification VALUES (DEFAULT, 1, 'You have purchased an item: Mona Lisa', timestamp '2020-05-15 01:00:00');
