...
### 9) Docker command, url and credentials

Doccker Command:

    run -it -p 8000:80 -e DB_DATABASE="lbaw2074" -e DB_USERNAME="lbaw2074" -e DB_PASSWORD="AJ771489" lbaw2074/lbaw2074
    
URL to the product: 

    http://lbaw2074.lbaw-prod.fe.up.pt
    
Credentials:

Admin:

    username: admin@artbay.pt
    password: 1234
    
Basic account:

    username: artstudio@hotmail.com
    password: 1234
